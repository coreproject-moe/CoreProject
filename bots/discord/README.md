...
New migrations should be added to `web/migrations/versions/`:
...
If u want to create a new file with tables u should import tables to `web/migrations/env.py`

```
import web.users.tables # import new files here
```
