...
const Home: NextPage = () => {
    ...
    useEffect(() => {
        setTimeout(() => {
            showNotification({
                ...
                message:
                    "Thanks for visiting AnimeCore.This site is still a work in-progress,so there's quite a bit of limited functionality.Feel free to check us over at Github - https://github.com/baseplate-admin/coreProject",
                styles: (theme) => ({
                    root: {
    ...
    const data = [
        ...
        },
        {
            ...
            backgroundImage: '/images/Konosuba-poster.avif',
            backgroundBanner:
        ...
        },
        {
            ...
            backgroundImage: '/images/Ajin-poster.avif',
            backgroundBanner:
        ...
        },
        {
            ...
            backgroundImage: '/images/Jujutsu-Kaisen-poster.avif',
            backgroundBanner:
        ...
        },
        {
            ...
            backgroundImage: '/images/Tate-No-Yuusha-No-Nariagari-poster.avif',
            backgroundBanner:
        ...
        },
        {
            ...
            backgroundImage: '/images/Kaguya-Sama-Ultra-Romantic-poster.avif',
            backgroundBanner:
        ...
        },
        {
            ...
            backgroundImage: '/images/Shingeki-No-Basamut-poster.avif',
            backgroundBanner:
        ...
        },
        {
            ...
            backgroundImage: '/images/Bungou-Stray-Dogs-poster.avif',
            backgroundBanner:
