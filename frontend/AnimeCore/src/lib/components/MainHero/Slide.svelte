...
<div
    class="hero min-h-[60vh] md:min-h-screen place-items-end bg-center bg-no-repeat"
    style="background-image: url('{backgroundImage}');"
>
    <div class="hero-overlay bg-opacity-60 bg-gradient-to-t from-base-100 via-base-100/[.45]">
