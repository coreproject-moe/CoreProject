export const anime_list = [
  {
    ...
    Hyouka follows the four members of the Classics Club—including Orekis friends Satoshi Fukube and Mayaka Ibara—as , driven by Chitandas insatiable curiosity, solve the trivial yet intriguing mysteries that permeate their daily lives.`,
    generes: [
      'Mystery', 'Slice of Life'
    ],
    cardBackgroundImage: 'https://cdn.myanimelist.net/images/anime/13/50521.jpg',
    bannerBackgroundImage: 'https://i.imgur.com/G1eZVz0.jpg',
  },
]
