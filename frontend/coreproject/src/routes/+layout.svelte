	...
	<AppShell>
		<svelte:fragment slot="header">
			<div class="h-24 flex justify-between">
				<Logo height="48" width="33.6" class="mt-12 mx-12" />
		...
		<svelte:fragment slot="sidebarLeft">
			<div class="w-32 flex justify-center mt-14 flex-col items-center">
				<button type="button" class="btn-icon bg-warning-400 rounded-lg p-0">
					<Search color="black" width="20" height="20" />
				</button>

				<button type="button" class="btn-icon bg-initial rounded-lg p-0 mt-14"> Home </button>
			</div>
		</svelte:fragment>
