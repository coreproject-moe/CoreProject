<section class="mt-20 flex flex-col p-5 md:mt-0 md:gap-[1.5vw] md:pb-[2.5vw] md:pl-[1.5vw] md:pr-[3.75vw] md:pt-0">
    ...
    <div class="mt-3 flex items-end justify-between gap-3 md:mt-0 md:gap-0">
        <div class="flex items-center gap-3 md:gap-[1.5vw]">
            ...
            <div class="md:flex flex-col md:gap-[0.35vw] group">
                <span class="font-semibold leading-none md:text-[1vw]">Genres</span>
                <div class="relative flex items-center">
            ...
            <div class="md:flex flex-col md:gap-[0.35vw] group">
                <span class="font-semibold leading-none md:text-[1vw]">Year</span>
                <div class="relative flex items-center">
                    <span class="absolute cursor-pointer opacity-100 duration-300 group-focus-within:opacity-0">
                        <span class="ml-3 text-base md:ml-[1vw] md:text-[0.9vw]">Any</span>
                    </span>
            ...
            <div class="md:flex flex-col md:gap-[0.35vw] group">
                <span class="font-semibold leading-none md:text-[1vw]">Season</span>
                <div class="relative flex items-center">
                    <span class="absolute cursor-pointer opacity-100 duration-300 group-focus-within:opacity-0">
                        <span class="ml-3 text-base md:ml-[1vw] md:text-[0.9vw]">Any</span>
                    </span>
            ...
            <div class="md:flex flex-col md:gap-[0.35vw] group">
                <span class="font-semibold leading-none md:text-[1vw]">Format</span>
                <div class="relative flex items-center">
                    <span class="absolute cursor-pointer opacity-100 duration-300 group-focus-within:opacity-0">
                        <span class="ml-3 text-base md:ml-[1vw] md:text-[0.9vw]">Any</span>
                    </span>
