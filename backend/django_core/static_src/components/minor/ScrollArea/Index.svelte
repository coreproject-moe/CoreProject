...
<div
    ...
    class={cn(parent_class, offset_scrollbar && "pr-3 md:pr-[0.75vw]", "block h-full w-full overflow-y-scroll overscroll-y-contain scrollbar-thin [scrollbar-color:_rgba(255,255,255,0.12)_transparent]")}
