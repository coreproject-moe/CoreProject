...
<ScrollArea>
    {#each episodes as episode}
        ...
        {@const formated_release_date = new FormatDate(episode.release_date)
        ...
        >
            ...
            />
            <div
                class="gradient absolute inset-0 bg-gradient-to-t from-secondary/75 to-transparent"
            />
            <div
                class="gradient absolute inset-0 bg-gradient-to-r from-secondary/50 to-transparent"
            />
