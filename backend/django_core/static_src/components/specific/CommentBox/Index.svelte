...
<div class="flex flex-col gap-3 md:gap-[0.75vw]">
    <div
        class="ring-surface-300/25 relative flex flex-col rounded-lg ring-2 transition duration-300 focus-within:ring-primary md:rounded-[0.75vw] md:ring-[0.15vw]"
    >
    ...
    <div class="flex justify-between gap-5 md:gap-[1vw]">
        <comment-alert class="flex items-center gap-3 md:gap-[0.625vw]">
            ...
            <p
                class="text-surface-300 text-[0.65rem] font-light leading-tight md:text-[0.75vw] md:leading-[1.125vw]"
            >
        ...
        <button
            ...
            class={cn(
                ...
                "btn btn-primary h-9 min-h-full w-40 rounded text-sm font-semibold text-accent md:h-[2.2vw] md:w-[6vw] md:rounded-[0.375vw] md:text-[0.85vw]"
            )}
        >
            Comment
        </button>
